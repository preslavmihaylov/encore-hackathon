...
export function Environment(name: string): BaseURL {
    return `https://${name}-uptime-73o2.encr.app`
}
...
/**
 * Client is an API client for the uptime-73o2 Encore application. 
 */
...
export namespace monitor {
    ...
    export class ServiceClient {
        ...
        public async Check(siteID: number): Promise<void> {
            await this.baseClient.callAPI("POST", `/check/${encodeURIComponent(siteID)}`)
        }
        ...
        public async CheckAll(): Promise<void> {
            await this.baseClient.callAPI("POST", `/checkall`)
        }
        ...
        public async Ping(url: string[]): Promise<PingResponse> {
            ...
            const resp = await this.baseClient.callAPI("POST", `/ping/${url.map(encodeURIComponent).join("/")}`)
        ...
        public async Status(): Promise<StatusResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/status`)
...
export namespace site {
    ...
    export class ServiceClient {
        ...
        public async Delete(siteID: number): Promise<void> {
            await this.baseClient.callAPI("DELETE", `/site/${encodeURIComponent(siteID)}`)
        }
        ...
        public async Get(siteID: number): Promise<Site> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/site/${encodeURIComponent(siteID)}`)
            return await resp.json() as Site
        }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "uptime-73o2-Generated-TS-Client (Encore/v1.36.3)";
        }
